...
var require_isomorphic_unfetch = __commonJS({
  "node_modules/.pnpm/isomorphic-unfetch@3.1.0/node_modules/isomorphic-unfetch/index.js"(exports, module2) {
    ...
    module2.exports = global.fetch = global.fetch || (typeof process == "undefined" ? r(require_unfetch()) : function(url, opts) {
      return r(require_lib3())(String(url).replace(/^\/\//g, "https://"), opts);
    });
  }
});
...
// node_modules/.pnpm/afdian@0.0.2/node_modules/afdian/dist/main.js
var require_main = __commonJS({
  "node_modules/.pnpm/afdian@0.0.2/node_modules/afdian/dist/main.js"(exports, module2) {
    var $1ZQrD$isomorphicunfetch = require_isomorphic_unfetch();
    var $1ZQrD$cryptojsmd5 = require_md5();
    ...
    $parcel$export(module2.exports, "default", () => $5e2f01247a5d6f10$export$2e2bcd8739ae039);
    var $374b01bd2de05971$exports = {};
    $parcel$export($374b01bd2de05971$exports, "Afdian", () => $374b01bd2de05971$export$5075110fe13e4f25);
    var $75fd649c5d1ad520$var$API_BASE = "https://afdian.net/api/open";
    var $75fd649c5d1ad520$var$getUrl = (path) => `${$75fd649c5d1ad520$var$API_BASE}/${path}`;
    var $75fd649c5d1ad520$export$2e2bcd8739ae039 = {
      ping: $75fd649c5d1ad520$var$getUrl("ping"),
      queryOrder: $75fd649c5d1ad520$var$getUrl("query-order"),
      querySponsor: $75fd649c5d1ad520$var$getUrl("query-sponsor")
    };
    var $08291d37a2d58607$export$6c5295ef7e82f2b2 = (userId2, params) => {
      const req = {
        user_id: userId2,
    ...
    var $08291d37a2d58607$export$aa7d25cddbad24ed = (token2, body) => {
      const toSign = `${token2}params${body.params}ts${body.ts}user_id${body.user_id}`;
      const sign = $parcel$interopDefault($1ZQrD$cryptojsmd5)(toSign).toString();
      return {
        ...body,
        sign
      };
    };
    var $374b01bd2de05971$export$5075110fe13e4f25 = class {
      constructor(opts) {
        const { userId: userId2, token: token2 } = opts;
        this.userId = userId2;
        this.token = token2;
      }
      send(url, params) {
        const signed = $08291d37a2d58607$export$aa7d25cddbad24ed(this.token, $08291d37a2d58607$export$6c5295ef7e82f2b2(this.userId, params));
        return $parcel$interopDefault($1ZQrD$isomorphicunfetch)(url, {
          method: "POST",
          headers: {
      ...
      ping() {
        return this.send($75fd649c5d1ad520$export$2e2bcd8739ae039.ping);
      }
      queryOrder(page) {
        return this.send($75fd649c5d1ad520$export$2e2bcd8739ae039.queryOrder, {
          page
        });
      }
      querySponsor(page1) {
        return this.send($75fd649c5d1ad520$export$2e2bcd8739ae039.querySponsor, {
          page: page1
        });
      }
    };
    var $926f150b8c018491$exports = {};
    var $5e2f01247a5d6f10$export$2e2bcd8739ae039 = $374b01bd2de05971$export$5075110fe13e4f25;
    $parcel$exportWildcard(module2.exports, $374b01bd2de05971$exports);
    $parcel$exportWildcard(module2.exports, $926f150b8c018491$exports);
  }
});
...
var fs = require("fs");
var { Afdian } = require_main();
var userId = core.getInput("user-id") || process.env.AFDIAN_USER_ID;
var token = core.getInput("token") || process.env.AFDIAN_TOKEN;
var mdPath = core.getMultilineInput("markdown", { required: false }) || ["README.md"];
var client = new Afdian({
  userId,
  token
});
async function main() {
